...
<div align="center"> <img src="https://rb3pc.milohax.org/images/instruments/cont/midikeyscontroller.png" alt="Controller" title="Controller"></div>
...
>![A picture of a MIDI controller's back, showing a USB port and a sustain pedal](https://rb3pc.milohax.org/images/midi/usbkeys.png "USB Keyboard")  

**If your keyboard only has a MIDI output, you will need a MIDI to USB interface**.

>![A picture of a MIDI controller's back, showing a 5-DIN MIDI input and output highlighted in yellow with a solid white outline, and multiple pedal inputs.](https://rb3pc.milohax.org/images/midi/midikeys.png "MIDI Keyboard")  
...
![A picture of a 37 key keyboard, showing the second octave mapped to PlayStation buttons, C3 to E3 under a red color, F3 to B3 under a yellow color, C4 to E4 under a blue color, F4 to B4 under a green color, and C5 under an orange color.](https://rb3pc.milohax.org/images/midi/keysctrl.png "MIDI Keyboard Reference")

| **Note#** | **Note** | **Note (Yamaha)** | **Button** |
|:-------:|:--------:|:-----------------:|:----------:|
| #36 | C2 | C1 | ![Select](https://rb3pc.milohax.org/images/btns/ctrls/ps3/sel.png "Select") |
| #38 | D2 | D1 | ![D-Pad Left](https://rb3pc.milohax.org/images/btns/ctrls/ps3/dl.png "D-Pad Left") |
| #40 | E2 | E1 | ![D-Pad Right](https://rb3pc.milohax.org/images/btns/ctrls/ps3/dr.png "D-Pad Right") |
| #41 | F2 | F1 | ![D-Pad Up](https://rb3pc.milohax.org/images/btns/ctrls/ps3/du.png "D-Pad Up") |
| #43 | G2 | G1 | ![D-Pad Down](https://rb3pc.milohax.org/images/btns/ctrls/ps3/dd.png "D-Pad Down") |
| #45 | A2 | A1 | Deploy Overdrive |
| #37 | C#2 | C#1 | ![Triangle](https://rb3pc.milohax.org/images/btns/ctrls/ps3/t.png "Triangle") |
| #39 | D#2 | D#1 | ![Square](https://rb3pc.milohax.org/images/btns/ctrls/ps3/s.png "Square") |
| #42 | F#2 | F#1 | ![Circle](https://rb3pc.milohax.org/images/btns/ctrls/ps3/o.png "Circle") |
| #44 | G#2 | G#1 | ![Cross](https://rb3pc.milohax.org/images/btns/ctrls/ps3/x.png "Cross") |
