...
First, you'll need to [[download the file to enable increased memory support. Click here to download it]](https://carlmylo.github.io/docu-rpcs3/downloads/customconfigs/memory.zip){:target="_blank"}
