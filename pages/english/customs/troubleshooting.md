...
![A screenshot of Rock Band 3, showing songs with a darker color as they are disabled.](https://carlmylo.github.io/rb3-pc/images/trbl/online/missingsong.png "Rock Band 3: Missing Songs Example")
...
![A screenshot of Nautilus. A cursor hovers over "Batch Processor."](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautilushomebatchproc.png "Nautilus")
...
![A GIF of Nautilus' Batch DTA Processor. Songs are being dragged then dropped into it then, after "Begin" is click, it starts processing.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautilusbatchfix.gif "Batch DTA Processor")
...
![A screenshot of a file browser window. "dev_hdd0" is selected and the cursor is over "Open".](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautilusps3batchselect.png "Select DTA file to edit")
...
![A screenshot from Rock Band 3, warning the user that they're about to delete many songs from the library.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/rb3delwarn.png "Delete song")
...
![A screenshot of a file browser window. "songs.dta" is selected.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/findfolder.png "songs")
...
![A screenshot of a file browser window. Multiple songs are selected and the cursor hovers over a popup menu option that says "Delete."](https://carlmylo.github.io/rb3-pc/images/xtra/customs/packdelfolder.png "songs")
...
![A screenshot of the parental control menu in PlayStation 3's XMB home menu. The level is set to "Off".](https://carlmylo.github.io/rb3-pc/images/xtra/customs/ps3parental.png "Parental Control")
...
![A screenshot of a file browser window. A mogg file is selected.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/findmogg.png "MOGG File")
