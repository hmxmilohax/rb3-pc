...
* Puedes configurar ladeo (Tilt) pero es complicado y también va a funcionar como el botón de Select. Tienes que usar "Filter Noise" hasta que la configuración de controles detecte el giróscopo (sensor de ladeo) correcto. Es recomendado no molestar con esto.
...
| Left Stick: Down (No es recomendado) | ![Ladeo](https://rb3pc.milohax.org/images/btns/gtrs/ts.gif "Ladeo Vertical") |
| Left Stick: Down (No es recomendado) | ![Ladeo](https://rb3pc.milohax.org/images/btns/gtrs/ts.gif "Ladeo Horizontal") |
...
[[Descargar Perfil]](https://github.com/hmxmilohax/rb3-pc/raw/refs/heads/main/downloads/instrument-repo/PC%20Guitar%20Hero%20World%20Tour%20Guitar.7z)
