...
* Es mejor que uses la guitarra con su receptor propio, si lo tienes. [[Haz click aquí para ver como usarlo con el receptor]](https://carlmylo.github.io/docu-rpcs3/adv_passthrough_es){:target="_blank"}.
