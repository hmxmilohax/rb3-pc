...
![A screenshot of Rock Band 3, showing songs with a darker color as they are disabled.](https://carlmylo.github.io/rb3-pc/images/trbl/online/missingsonges.png "Rock Band 3: Missing Songs Example")
...
![Una captura de Nautilus. El cursor esta sobre "Batch Processor."](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautilushomebatchproc.png "Nautilus")
...
![Una animación de Nautilus' Batch DTA Processor. Las canciones son arrastradas a la pantalla y luego empiezan a hacer procesadas después de presionar "Begin."](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautilusbatchfix.gif "Batch DTA Processor")
...
![A screenshot of Nautilus's PS3 Converter. A cursor hovers over "Batch replace song IDs" under the "Numeric ID Options" menu.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautilusps3batchid.png "PS3 Converter")
...
![Una captura de un explorador de archivos. "dev_hdd0" is selected and El cursor esta sobre "Open".](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautilusps3batchselectes.png "Select DTA file to edit")
...
![A screenshot of Nautilus's PS3 Converter. It has just finished replacing custom songs without numeric IDs.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautilusps3batchdone.png "PS3 Converter")
...
![A screenshot of Nautilus's PS3 Converter. A cursor hovers over "Batch fix looping songs" under the "Tools" menu.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautilusps3batchloop.png "PS3 Converter")

3\. Va la carpeta donde esta el CON con problemas y selecciona la carpeta.  
Espera que termine.  
![A screenshot of Nautilus's PS3 Converter. It is in the process of fixing a looping file.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautilusps3batchloopproc.png "PS3 Converter")
...
![A screenshot from Rock Band 3, warning the user that they're about to delete many songs from the library.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/rb3delwarnes.png "Delete song")

La mejor manera de arreglar esto es usando el "Quick Pack Editor"

1\. Abre Nautilus y elije `Quick Pack Editor`.  
![A screenshot of Nautilus. A cursor hovers over "Quick Pack Editor."](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautilushomepack.png "Nautilus")
...
![Una captura de un explorador de archivos. "songs.dta" is selected.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/findfolder.png "songs")
...
![A GIF of a "songs.dta" file being dragged and dropped into Nautilus' Quick Pack Editor.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautiluspackdrag.gif "Quick Pack Editor")
...
![Una captura de un explorador de archivos. Multiple songs are selected and the cursor hovers over a popup menu option that says "Delete."](https://carlmylo.github.io/rb3-pc/images/xtra/customs/packdelfolderes.png "songs")
...
![A screenshot of Rock Band 3's song library. It shows as greyed out song.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/ps3grey.png "Rock Band 3: Grey Songs")
...
![A screenshot of the parental control menu in PlayStation 3's XMB home menu. The level is set to "Off".](https://carlmylo.github.io/rb3-pc/images/xtra/customs/ps3parentales.png "Parental Control")
...
![A screenshot of Nautilus. A cursor hovers over "Batch Cryptor."](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautilushomecrypt.png "Nautilus")

2\. Cambia a la opcion de `Decrypt` abajo de la pantalla.  
![A screenshot of Batch Cryptor. The mode has been switched to "Decrypt."](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautiluscryptdecrypt.png "Batch Cryptor")
...
![Una captura de un explorador de archivos. A mogg file is selected.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/findmogg.png "MOGG File")

4\. Arrastra el archivo `.mogg` en la pantalla de `Batch Cryptor` y haz click en `Begin`.  
![A GIF of a .mogg file being dropped into "Batch Cryptor" the being decrypted.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/nautiluscryptdecryptmogg.gif "Quick Convert")
...
![A GIF of a .mogg file within the "decrypted" folder being cut then pasted in the folder before it. It replaces the old .mogg file.](https://carlmylo.github.io/rb3-pc/images/xtra/customs/moggreplace.gif "Quick Convert")
