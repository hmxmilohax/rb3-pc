...
![A screenshot of Rock Band 3, showing songs with a darker color as they are disabled.](https://carlmylo.github.io/docu-rpcs3/images/trbl/online/missingsonges.png "Rock Band 3: Missing Songs Example")
...
![Una captura de Nautilus. El cursor esta sobre "Batch Processor."](https://carlmylo.github.io/docu-rpcs3/images/xtra/customs/nautilushomebatchproc.png "Nautilus")
...
![Una animación de Nautilus' Batch DTA Processor. Las canciones son arrastradas a la pantalla y luego empiezan a hacer procesadas después de presionar "Begin."](https://carlmylo.github.io/docu-rpcs3/images/xtra/customs/nautilusbatchfix.gif "Batch DTA Processor")

3\. Cuando termine, puedes cerrar `Batch Processor` y continuar con la cuarta parte del [[tutorial principal]](https://carlmylo.github.io/docu-rpcs3/customs_360toPS3_es#4){:target="_blank"}.

### Arreglando IDs de customs que ya están instaladas

1\. Abre Nautilus y elije `PS3 Converter`.  
![Una captura de Nautilus. El cursor esta sobre "PS3 Converter."](https://carlmylo.github.io/docu-rpcs3/images/xtra/customs/nautilushomeps3.png "Nautilus")
...
![Una captura de un explorador de archivos. "dev_hdd0" is selected and El cursor esta sobre "Open".](https://carlmylo.github.io/docu-rpcs3/images/xtra/customs/nautilusps3batchselectes.png "Select DTA file to edit")
...
4\. Cuando termine, Ya puedes continuar a la cuarta parte del[[tutorial principal]](https://carlmylo.github.io/docu-rpcs3/customs_360toPS3_es#4){:target="_blank"}.
...
![A screenshot from Rock Band 3, warning the user that they're about to delete many songs from the library.](https://carlmylo.github.io/docu-rpcs3/images/xtra/customs/rb3delwarnes.png "Delete song")
...
![Una captura de un explorador de archivos. "songs.dta" is selected.](https://carlmylo.github.io/docu-rpcs3/images/xtra/customs/findfolder.png "songs")
...
![Una captura de un explorador de archivos. Multiple songs are selected and the cursor hovers over a popup menu option that says "Delete."](https://carlmylo.github.io/docu-rpcs3/images/xtra/customs/packdelfolderes.png "songs")
...
![A screenshot of the parental control menu in PlayStation 3's XMB home menu. The level is set to "Off".](https://carlmylo.github.io/docu-rpcs3/images/xtra/customs/ps3parentales.png "Parental Control")
...
![Una captura de un explorador de archivos. A mogg file is selected.](https://carlmylo.github.io/docu-rpcs3/images/xtra/customs/findmogg.png "MOGG File")
