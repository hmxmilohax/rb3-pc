...
| [![Microsoft Windows' logo](images/old/inst/windows.png)](https://github.com/RPCS3/rpcs3-binaries-win/releases/download/build-9b3a878c189e4e688b6025de0d0ff659116dcade/rpcs3-v0.0.28-15417-9b3a878c_win64.7z "Windows Version") | [![Linux's Tux Mascot](images/old/inst/linux.png)](https://github.com/RPCS3/rpcs3-binaries-linux/releases/download/build-9b3a878c189e4e688b6025de0d0ff659116dcade/rpcs3-v0.0.28-15417-9b3a878c_linux64.AppImage "Linux Version") |
|---|---|

**Once it downloads, extract the .7zip file.**  
![A screenshot of the right click menu from Windows Explorer highlighting "Extract files..." from the 7-Zip category.](images/old/inst/extract.png "Extract Files")
...
![A screenshot of the Extract window from 7-zip. It shows the "Extract to" as C:\Games\RPCS3 and the box below it unchecked.](images/old/inst/extractdir.png "Extract")
...
[![A screenshot of Sony's "How to update PS3 console system software" page with the "Update using a computer" subcategory expanded.](images/old/inst/fwpage.png)](https://www.playstation.com/en-us/support/hardware/ps3/system-software/ "How to update PS3 console system software")


Now **open up RPCS3**. **Tick "I have read the Quickstart guide" and "Do not show again", then click "Continue."**  
![A screenshot of RPCS3 welcoming the user to RPCS3.](images/old/inst/rpcs3init.png "Welcome to RPCS3")

As mentioned earlier, this is an outdated build of RPCS3, and you'll be warned about this.
**Make sure you click "No."**
![A screenshot of alerting the user RPCS3 has an update available.](images/old/inst/rpcs3updwrn.png "Update Available")

**Drag** the **PS3UPDAT.PUP** file you just downloaded from Sony's website **into RPCS3** 
![A GIF of PS3UPDAT.PUP being dragged into RPCS3.](images/old/inst/rpcs3fwdnd.gif "PST3UPDAT.PUP")

**Click "Yes"** when the firmware installer prompts you.  
![A screenshot of RPCS3's Firmware Installer asking the user if they want to install the firmware named "PS3UPDAT.PUP".](images/old/inst/fwinstall.png "RPCS3 Firmware Installer")

**Let it install.**  
![A screenshot of RPCS3's Firmware Installer in the middle of installing firmware version 4.90.](images/old/inst/rpcs3fw.png "RPCS3 Firmware Installer progress")

**When it finishes, click "OK."**  
![A screenshot of RPCS3's Firmware Installer after a successful install of PS3 firmware and LLE modules.](images/old/inst/rpcs3fwdone.png "Success!")
...
![A screenshot of RPCS3 compiling PPU modules with a progress bar at 1/8th completion.](images/old/inst/rpcs3fwcomp.png "Compiling PPU modules...")
...
![A GIF of the dumped folder of Rock Band 3 being dragged into RPCS3, which updates RPCS3 to display Rock Band 3 in the game list.](images/old/inst/rpcs3rb3dnd.gif "Rock Band 3 [BLUS30463]")
...
[![Rock Band 3's PKG update in Edge's download tray.](images/old/inst/rb3pe.png)](http://b0.ww.np.dl.playstation.net/tppkg/np/BLUS30463/BLUS30463_T4/e52d21c696ed0fcf/UP8802-BLUS30463_00-ROCKBAND3PATCH05-A0105-V0100-PE.pkg "UP8802-BLUS30463_00-ROCKBAND3PATCH05-A0105-V0100-PE.pkg")
...
![A screenshot of RPCS3's Decrypter/ Installer asking if the user wants to install the Rock Band 3 Deluxe package file.](images/old/inst/rpcs3pkg.png "PKG Decrypter/ Installer")
...
![A screenshot of RPCS3's right click menu, showing "GUI" in the Configuration menu highlighted](images/old/conf/rpcs3gui.png "RPCS3 > Configuration > GUI")

**In "Check for updates on startup", change the option to "No", then click "Apply" then "Save."**  
![A screenshot of RPCS3's right click menu, showing "Create Custom Gamepad Configuration" highlighted](images/old/conf/rpcs3disupd.png "RPCS3 > Configuration > GUI")
...
![A screenshot of RPCS3's right click menu, showing "Create Custom Gamepad Configuration" highlighted](images/old/conf/rpcs3pad.png "Create Custom Gamepad Configuration")
...
|:------------------:|:---------------------:|:-----------------------:|
| Cross | ![Green Fret](images/old/btns/gtrs/gf.png "Green Fret") | ![Green Fret](images/old/btns/gtrs/gf.png "Green Fret") |
| Circle | ![Red Fret](images/old/btns/gtrs/rf.png "Red Fret") | ![Red Fret](images/old/btns/gtrs/rf.png "Red Fret") |
| Square | ![Blue Fret](images/old/btns/gtrs/bf.png "Blue Fret") | ![Yellow Fret](images/old/btns/gtrs/yf.png "Yellow Fret") |
| Triangle | ![Yellow Fret](images/old/btns/gtrs/yf.png "Yellow Fret") | ![Blue Fret](images/old/btns/gtrs/bf.png "Blue Fret") |
| L1 | ![Orange Fret](images/old/btns/gtrs/of.png "Orange Fret") | ![Orange Fret](images/old/btns/gtrs/of.png "Orange Fret") |
| D-Pad: Up | ![Strumbar Up](images/old/btns/gtrs/sbu.png "Strumbar Up") | ![Strumbar Up](images/old/btns/gtrs/sbu.png "Strumbar Up") |
| D-Pad: Down | ![Strumbar Down](images/old/btns/gtrs/sbd.png "Strumbar Down") | ![Strumbar Down](images/old/btns/gtrs/sbd.png "Strumbar Down") |
| Right Stick: <br/> Left/Right <br/> (ignore Left on some Wii guitars) | ![Whammy Bar](images/old/btns/gtrs/wb.png "Whammy Bar") | ![Whammy Bar](images/old/btns/gtrs/wb.png "Whammy Bar") |
| Right Stick: <br/> Up/Down <br/> (PS3/PS4/Wii guitars only) | ![Effects Switch](images/old/btns/gtrs/fx.png "Effects Switch") | |
| L2 <br/> (Xbox 360 guitars only) | ![Effects Switch](images/old/btns/gtrs/fx.png "Effects Switch") | |
| R1 | ![Tilt](images/old/btns/gtrs/ts.png "Tilt") | Does not work |
...
|:--------:|:---------------:|:-------------------:|:-----------------:|
| Cross | ![Green Pad](images/old/btns/drms/rb/gp.png "Green Pad") | ![Green Pad](images/old/btns/drms/rb/gp.png "Green Pad") | ![Green Pad](images/old/btns/drms/gh/gp.png "Green Pad") |
| Circle | ![Red Pad](images/old/btns/drms/rb/rp.png "Red Pad") | ![Red Pad](images/old/btns/drms/rb/rp.png "Red Pad") | ![Red Pad](images/old/btns/drms/gh/rp.png "Red Pad") |
| Square | ![Blue Pad](images/old/btns/drms/rb/bp.png "Blue Pad") | ![Blue Pad](images/old/btns/drms/rb/bp.png "Blue Pad") | ![Blue Pad](images/old/btns/drms/gh/bp.png "Blue Pad") |
| Triangle | ![Yellow Pad](images/old/btns/drms/rb/yp.png "Yellow Pad") | ![Yellow Pad](images/old/btns/drms/rb/yp.png "Yellow Pad") | ![Yellow Cymbal](images/old/btns/drms/gh/yc.png "Yellow Cymbal") |
| L1 | ![Foot Pedal](images/old/btns/drms/rb/kp.png "Foot Pedal") | ![Foot Pedal](images/old/btns/drms/rb/kp.png "Foot Pedal") | ![Foot Pedal](images/old/btns/drms/gh/kp.png "Foot Pedal") |
| D-Pad | ![D-Pad](images/old/btns/ctrls/xbox/dp.png "D-Pad") | ![D-Pad](images/old/btns/ctrls/xbox/dp.png "D-Pad") | ![D-Pad](images/old/btns/ctrls/xbox/dp.png "D-Pad") |
| R1 |  | ![Second Foot Pedal](images/old/btns/drms/rb/kp.png "Second Foot Pedal") | ![Orange Cymbal](images/old/btns/drms/gh/oc.png "Orange Cymbal") |
| R3 |  | Cymbal Modifier | |
| L3 |  | Pad Modifier | |
...
|:---------------------:|:---------------------:|:-------------------------------:|:-------------------:|
| ![Left Stick](images/old/btns/ctrls/ps4/ls.png "Left Stick") | ![Left Stick](images/old/btns/ctrls/xbox/ls.png "Left Stick") | Navigation |
| ![D-Pad](images/old/btns/ctrls/ps4/dp.png "D-Pad") | ![Left Stick](images/old/btns/ctrls/xbox/dp.png "D-Pad") | Navigation |
| ![Cross Button](images/old/btns/ctrls/ps4/x.png "Cross Button") | ![A Button](images/old/btns/ctrls/xbox/a.png "A Button") | Select                          |
| ![Circle Button](images/old/btns/ctrls/ps4/o.png "Circle Button") | ![B Button](images/old/btns/ctrls/xbox/b.png "B Button") | Back                            | Mic 3 Volume (Song) |
| ![Square Button](images/old/btns/ctrls/ps4/s.png "Square Button") | ![X Button](images/old/btns/ctrls/xbox/x.png "X Button") | Mic 1 Volume (Song) |
| ![Triangle Button](images/old/btns/ctrls/ps4/t.png "Triangle Button") | ![Y Button](images/old/btns/ctrls/xbox/y.png "Y Button") | View More Info (Library)        | Mic 2 Volume (Song) |
| ![Options Button](images/old/btns/ctrls/ps4/opt.png "Options Button") | ![Options Button](images/old/btns/ctrls/xbox/opt.png "Options Button") | Options                         | Pause (Song)        |
| ![Share Button](images/old/btns/ctrls/ps4/shr.png "Share Button") | ![View Button](images/old/btns/ctrls/xbox/viw.png "View Button") | Filters (Library)               | Overdrive (Song)    |
| ![L1 Button](images/old/btns/ctrls/ps4/l1.png "L1 Button") | ![Left Bumper](images/old/btns/ctrls/xbox/lb.png "Left Bumper") | Guide Part Selection (Practice) |
| ![L2 Trigger](images/old/btns/ctrls/ps4/l2.png "L2 Trigger") | ![Left Trigger](images/old/btns/ctrls/xbox/lt.png "Left Trigger") | Vocal Part Selection (Practice) |
| ![R1 Button](images/old/btns/ctrls/ps4/r1.png "R1 Button") | ![Right Bumper](images/old/btns/ctrls/xbox/rb.png "Right Bumper") | Vocal Track Volume (Song)       |
| ![R2 Trigger](images/old/btns/ctrls/ps4/r2.png "R2 Trigger") | ![Right Trigger](images/old/btns/ctrls/xbox/rt.png "Right Trigger") | Pitch Correction (Song)         |
...
![A screenshot of RPCS3's Gamepad Settings with a Höfner](images/old/conf/rpcs3padexm.png "Gamepad Settings with a Wii The Beatles: Rock Band Höfner guitar controller")

<br/>

## USER ACCOUNT:
In RPCS3, go to **Manage > User Accounts** 
![RPCS3 showing "User Accounts" option under the "Manage" menu.](images/old/conf/rpcs3user.png "RPCS3: User Accounts")
...
![RPCS3's "User Manager", showing the default username.](images/old/conf/rpcs3rename.png "RPCS3: User Accounts")
...
![A screenshot of RPCS3's right click menu, showing "Create Custom Configuration" highlighted](images/old/cust/rpcs3customconfig.png "Create Custom Gamepad Configuration")
...
| COLOR | MEANING |
|---|---|
| ![A red square with a dashed outline.](images/old/cust/bigred.png "Red Square") | **REQUIRED** |
| ![A yellow square with a dotted outline.](images/old/cust/bigyellow.png "Yellow Square") | **Performance Tweaks** |
| ![A blue square with a solid outline.](images/old/cust/bigblue.png "Blue Square") | **Optional** |
...
![A screenshot of Rock Band 3's CPU custom settings, showing SPU XFloat Accuracy, SPU Block Size, and Preferred SPU Threads highlighted in yellow with a dotted outline.](images/old/cust/cpu.png "CPU")
* ![A yellow square with a dotted outline.](images/old/cust/smallyellow.png "Yellow Square") **Improved CPU performance, at the cost of bottlenecking on certain machines**: 
...
## GPU
![A screenshot of Rock Band 3's GPU custom settings, highlighting Write Color Settings highlighted in red with a dashed outline, ZCULL Accuracy, Resolution Scale, Resolution Scale Threshold, Frame Limit, Shader Quality, and VSync highlighted in yellow with a dotted outline.](images/old/cust/gpu.png "GPU")
...
* ![A yellow square with a dotted outline.](images/old/cust/smallyellow.png "Yellow Square") Performance Tweaks: 
...
## Audio
![A screenshot of Rock Band 3's Audio custom settings, highlighting Enable Buffering in red with a dashed outline, Audio Buffer highlighted in yellow with a dotted outline, and Microphone Settings, Microphone Type (Standard), Mic1, Mic2, Mic3, and Mic4 highlighted in blue with a solid outline.](images/old/cust/audio.png "Audio")
* ![A light red square with a dashed outline.](images/old/cust/smallred.png "Light Red Square") REQUIRED: 
...
* ![A light yellow square with a dotted outline.](images/old/cust/smallyellow.png "Light Yellow Square") Tweak depending on audio hardware: 
...
* ![A blue square with a solid outline.](images/old/cust/smallblue.png "Blue Square") For Vocalists: 
...
![A picture of a MIDI controller's back, showing a USB port and a sustain pedal](images/old/midi/usbkeys.png "USB Keyboard")  


**If your keyboard only has a MIDI output, you will need a MIDI to USB interface**.
![A picture of a MIDI controller's back, showing a 5-DIN MIDI input and output, and multiple pedal inputs.](images/old/midi/midikeys.png "MIDI Keyboard")  

**The same applies to Rock Band 3 Pro Guitars** as they only have MIDI outputs.
![A picture of a Rock Band 3 Fender Mustang Pro Guitar, showing a 5-DIN MIDI output.](images/old/midi/midiprotar.png "Mustang Pro Guitar MIDI Output")  

Here's an example of a MIDI to USB interface. Most will come with an LED indicator to show activity. **To check that you've plugged it in correctly, you should see “MIDI In” blinking when you press a key**.  
![A picture of a MIDI to USB interface.](images/old/midi/miditousb.png "MIDI to USB interface")  


**If you have an audio interface, you may already have a way to plug in MIDI** to your computer, as some audio interfaces come with MIDI inputs. For example, this Scarlett has MIDI connections in the back.  
>![A picture of a Focusrite Scarlett's rear, showing a USB port, and 5-DIN MIDI input and output.](images/old/midi/midifs.png "Focusrite Scarlett MIDI in/out")  


**If everything's connected**, let's go ahead and **focus on RPCS3's I/O tab.**  
![A screenshot of Rock Band 3's I/O custom settings, showing Emulated MIDI Devices, device type, and device selection highlighted in blue with a solid outline.](images/old/cust/io.png "I/O")
* ![A blue square with a solid outline.](images/old/cust/smallblue.png "Blue Square") For third party Keyboard and wired Pro Guitar players: 
...
![A picture of a 37 key keyboard, showing the second octave mapped to PlayStation buttons, C3 to E3 under a red color, F3 to B3 under a yellow color, C4 to E4 under a blue color, F4 to B4 under a green color, and C5 under an orange color.](images/old/midi/keysctrl.png "MIDI Keyboard Reference")  
...
## ADVANCED
![A screenshot of Rock Band 3's Advanced custom settings, showing "Exclusive Fullscreen Mode (Automatic (Default)), and Driver Wake-Up Delay (1µ) in green.](images/old/cust/advanced.png "Advanced")
* ![A yellow square with a dotted outline.](images/old/cust/smallyellow.png "Yellow Square") Depending on your computer: 
...
* ![A blue square with a solid outline.](images/old/cust/smallblue.png "Blue Square") For higher framerates: 
...
## EMULATOR
![A screenshot of Rock Band 3's Emulator custom settings, showing "Show trophy popups", "Show PPU compilation hint", "Show Shader Compilation hint", "Start Games in fullscreen mode", "Use native user interface".](images/old/cust/emulator.png "Emulator")
You can leave this as is if you want, but I would consider changing the following options:
* ![A blue square with a solid outline.](images/old/cust/smallblue.png "Blue Square") Optional tweaks: 
...
![A screenshot of Zadig showing "List All Devices" under "Options" highlighted.](images/old/pass/zadiglistall.png "Zadig: Options: List All Devices")
...
![A screenshot of Zadig showing "Harmonix RB3 Mustang Guitar for PlayStation® 3" highlighted in the devices listed.](images/old/pass/zadigsel.png "Zadig: Harmonix RB3 Mustang Guitar for PlayStation® 3")
...
![A screenshot of Zadig with "Replace Driver" highlighted.](images/old/pass/zadigreplace.png "Zadig: Replace Driver")
...
![A screenshot of Zadig warning the user that they're about to modify a system driver, with "Yes" highlighted](images/old/pass/zadigreplace.png "Zadig: Warning - System Driver")

It will then install the driver. As the program says, it may take a few minutes.  
![A screenshot of Zadig in the middle of a driver install.](images/old/pass/zadigprogress.png "Zadig: Installing Driver...")


If everything goes well, you will get this message:  
![A screenshot of Zadig telling the user that the driver was installed successfully with "Close" highlighted.](images/old/pass/zadigdone.png "Zadig: Success")
...
![A picture of a Mustang Pro Guitar with the second player LED lit up.](images/old/pass/protaron.png "Fender Mustang Pro Guitar: Player 2")

Likewise, in Rock Band 3, you will see the instrument ready to join.  
![A screenshot of Rock Band 3 with a Pro Guitar ready to join.](images/old/pass/rb3player.png "Rock Band 3: Pro Guitar ready to join")
...
*   **_Stuttering Audio_**
	...
	* [![A video thumbnail that reads "Click here for audio example."](images/old/xtra/badaudio.png)](https://www.youtube.com/watch?v=UoCMEQbNThs&t=20s "Rock Band 3 Deluxe - Low-End Low-Buffer Autoplay - YouTube")
